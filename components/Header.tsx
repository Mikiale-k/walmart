...
const Header = () => {
  ...
  return (
    <header className="flex flex-col md:flex-row items-center bg-walmart px-10 py-7 space-x-2">
      ...
      >
        <input
          ...
          className="text-black flex-1 px-4 rounded-l-full outline-none placeholder:text-sm"
        />
        <button>
